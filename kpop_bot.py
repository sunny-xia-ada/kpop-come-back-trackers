...
<body>
    ...
    <script>
        ...
        // ---------------------------------------------------------
        // BTS 2026 TOUR INJECTION (PROFESSIONAL DATA)
        // ---------------------------------------------------------
        if(KPOP_DATA['BTS']) {
            KPOP_DATA['BTS'].tour = [
                // STANFORD (Closest)
                {
                    ...
                    url: "https://www.stubhub.com/bts-stanford-tickets-5-16-2026/event/159283741/?quantity=1"
                },
                // LOS ANGELES (West Coast Hub)
                {
                    ...
                    url: "https://www.stubhub.com/bts-inglewood-tickets-9-1-2026/event/160262066/?quantity=1"
                },
                // LAS VEGAS (West)
                {
                    date: "2026-05-23", city: "Las Vegas, NV", venue: "Allegiant Stadium",
                    distance_miles: 1100,
                    prices: { "StubHub": 213, "Ticketmaster": 250, "Vivid": 220, "SeatGeek": 230 },
                    url: "https://www.stubhub.com/bts-las-vegas-tickets-5-23-2026/event/159928374/?quantity=1"
                },
                // CHICAGO (Midwest)
                {
                    ...
                    url: "https://www.stubhub.com/bts-chicago-tickets-8-27-2026/event/159827364/?quantity=1"
                },
                // NEW JERSEY (East)
                {
                    ...
                    url: "https://www.stubhub.com/bts-east-rutherford-tickets-8-1-2026/event/159736251/?quantity=1"
                },
                // TAMPA (South)
                {
                    date: "2026-04-25", city: "Tampa, FL", venue: "Raymond James Stadium",
                    distance_miles: 3100,
                    prices: { "StubHub": 206, "Ticketmaster": 240, "Vivid": 215, "SeatGeek": 225 },
                    url: "https://www.stubhub.com/bts-tampa-tickets-4-25-2026/event/159625142/?quantity=1"
                }
            ];
        }
        ...
        function renderTabContent(data, tab) {
            ...
            if(tab === 'tour' && data.tour && data.tour[0]?.prices) {
                ...
                const rows = recs.map((t, index) => {
                    ...
                    const badgeHtml = isTopPick ? `<div class="gold-badge">⭐⭐⭐⭐⭐ BEST CHOICE</div>` : '';
                    ...
                    return `
                        <div class="${rowClass}">
                            ...
                            <a href="${t.url || '#'}" target="_blank" class="buy-btn">Buy Ticket</a>
                        </div>
                    `;
                }).join('');
