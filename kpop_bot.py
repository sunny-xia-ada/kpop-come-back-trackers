                    ...
                    <div class="hero-content">
                        <div class="tabs">
                            <button class="tab-btn ${currentTab === 'tour' ? 'active' : ''}" onclick="switchTab('tour')">
                                <div>Live Tour</div>
                                <div style="font-size:0.7rem; opacity:0.7; margin-top:2px;">巡演</div>
                            </button>
                            <button class="tab-btn ${currentTab === 'comeback' ? 'active' : ''}" onclick="switchTab('comeback')">
                                <div>New Music</div>
                                <div style="font-size:0.7rem; opacity:0.7; margin-top:2px;">新歌</div>
                            </button>
                            <button class="tab-btn ${currentTab === 'closet' ? 'active' : ''}" onclick="switchTab('closet')">
                                <div>Idol Closet 🛍️</div>
                                <div style="font-size:0.7rem; opacity:0.7; margin-top:2px;">偶像衣橱</div>
                            </button>
                        </div>
                        <div id="tab-content">
